...
class TensorFusion(nn.Module):
    ...
    def __init__(self, input_dims, output_dim, dropout=0.1):
        ...
        # In this context, input_dims are all hidden_dim after the encoders
        hidden_dim = input_dims[0]

        # Bilinear layers for pairwise fusion
        ...
        # Final fusion layer to combine pairwise features
